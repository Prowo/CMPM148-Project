...
=== location_description
    ...
    *[Victim's Job Site]
    ...
    +{ locationsVisited ? bankvisit or locationsVisited ? jobvisit} [Go to department]
...
The bank is clean and exceptionally well-ordained with greek deco. It is surprising busy depsite how many tellers there are. You see a young beutiful lady that is open at the counter.
...
*"You are definitely no sham[."] My work has taken a turn that not I even I can described. There is a strangeness going on that i'm not sure know how to handle"
     ...
     "Your problems will be solved if you deal with..." and she flips the last card revealing the Hierophant. "Find this person and it will solve all your fears."
